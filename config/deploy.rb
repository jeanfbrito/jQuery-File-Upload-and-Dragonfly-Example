...
# Application
set :application, "imobili.us" # Application name
 
# The addresses of servers involved in the deployment
role :web, "dev.imobili.us"
role :app, "dev.imobili.us"
role :db, "dev.imobili.us", :primary => true
 
# Repository informations
set :scm, :git
set :repository, "git@github.com:jeanfbrito/jQuery-File-Upload-and-Dragonfly-Example.git"
set :branch, 'master'
